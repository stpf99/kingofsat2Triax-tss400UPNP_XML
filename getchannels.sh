...
python getchannels.py $SERVER pos-13E.php 1

# merge all xml files together
echo "<?xml version="1.0" encoding="UTF-8"?><channelTable msys="DVB-S">" >> allChannels.xml
cat *.xml >> allChannels.xml
echo "</channelTable>" >> allChannels.xml
